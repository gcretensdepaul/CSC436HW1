...
const Product = class Product {
     ...
     * Reference: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array 
     */
    static halfOff = (products) => {return Array.from(products, (product) => new Product(`${product.name},${product.price/2},${product.availability}`))}
    ...
    static printProducts = (products) => {
        products.forEach((product) => {
            console.log(`Product: ${product.name}, Cost: ${product.price.toLocaleString('en-US', {style: 'currency', currency: 'USD',})}, Availability: ${product.availability === "In Stock" ? "Yes" : "No"}`);
        });
    }
